...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center px-4 py-10 overflow-hidden bg-surface-container-low">
      {/* Material ambient background */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background:
            'radial-gradient(ellipse 60% 50% at 15% 20%, rgba(66,120,179,0.10), transparent 65%),' +
            'radial-gradient(ellipse 55% 45% at 85% 80%, rgba(102,133,103,0.08), transparent 65%)',
        }}
        aria-hidden
      />
