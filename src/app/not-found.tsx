  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-10 bg-surface">
      <div className="w-full max-w-[440px]">
        ...
        <div className="bg-surface-container-lowest rounded-md shadow-elev-1 p-7 sm:p-8 border border-outline-variant/60 text-center">
          <div className="mx-auto w-14 h-14 rounded-full bg-surface-container-high text-on-surface-variant flex items-center justify-center mb-4">
            <Search size={26} />
          </div>
          <h2 className="text-title-lg text-on-surface">找不到頁面</h2>
